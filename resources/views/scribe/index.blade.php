                ...
                <li class="tocify-item level-1" data-unique="health">
                    <a href="#health">Health</a>
                                    ...
                                    <ul id="tocify-subheader-health" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="health-GETapi-v1-ping">
                                <a href="#health-GETapi-v1-ping">Check Program Health</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="product">
                    <a href="#product">Product</a>
                                    ...
                                    <ul id="tocify-subheader-product" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="product-GETapi-v1-products">
                                <a href="#product-GETapi-v1-products">List all products</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="product-GETapi-v1-products--id-">
                                <a href="#product-GETapi-v1-products--id-">Display Single Product</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="product-POSTapi-v1-products">
                                <a href="#product-POSTapi-v1-products">Create New Product</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This is an assessment for Pay4Me.app to build a crud application using filament, with some unit tests and documentation to be done using Laravel Scribe</p>
<aside>
...
<p>This API is not authenticated.</p>
    ...
    <p>Endpoints for checking health of api</p>

                                <h2 id="health-GETapi-v1-ping">Check Program Health</h2>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Product Related Apis</p>

                                <h2 id="product-GETapi-v1-products">List all products</h2>

<p>
</p>

<p>This endpoint returns a paginated list of all products</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="product-GETapi-v1-products--id-">Display Single Product</h2>

<p>
</p>

<p>This endpoint displays a specific product</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/products/47" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/products/47"
);
...
<code class="language-json" style="max-height: 300px;">{&quot;message&quot;: &quot;App\Models\Product not found&quot;}</code>
 </pre>
    </span>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>47</code></p>
            </div>
                    </form>

                    <h2 id="product-POSTapi-v1-products">Create New Product</h2>

<p>
</p>

<p>This endpoint creates a new product</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Monkey King Wukong"
               data-component="body">
    <br>
<p>The name of the product Example: <code>Monkey King Wukong</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The category of the product Example: <code>game</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>An integer representing status Example: <code>inactive</code></p>
Must be one of:
